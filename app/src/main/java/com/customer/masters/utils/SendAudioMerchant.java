...
import com.customer.masters.activity.ChatActivityMerchant;
...
import com.customer.masters.models.Chat;
...
public class SendAudioMerchant {
    ...
    public SendAudioMerchant(Context context, EditText message_field,
                             DatabaseReference rootref, DatabaseReference adduser_to_inbox
            , String senderid, String receiverid, String tokenku, String tokendriver, String receiver_name, String receiver_pic, String isdriver) {
    ...
    public void UploadAudio(){
        ...
        ChatActivityMerchant.uploadingAudioId =key;
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ChatActivityMerchant.uploadingAudioId ="none";
                        ...
                        if (jikadriver.equals("1")) {
                            ...
                            message_user_map.put("tokendriver", tokenku);
                            message_user_map.put("tokenuser", tokendriver);
                        ...
                        rootref.updateChildren(user_map, new DatabaseReference.CompletionListener() {
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                ...
                                if (jikadriver.equals("1")) {
                                    ...
                                    receivermap.put("tokendriver", tokenku);
                                    receivermap.put("tokenuser", tokendriver);
